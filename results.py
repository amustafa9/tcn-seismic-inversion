...
plt.savefig('Scatter_Ridge.png',bbox_inches='tight')
plt.show()
...
AI = np.expand_dims(AI, axis=1)
AI_inv = np.expand_dims(AI_inv, axis=1)
x_loc = np.array([3400,6800,10200,13600]) ## Choose 4 number betweeb 0 and 17000 (distance in meters along the horizontal)
...
fig.legend([p1[0],p2[0]],["True AI","Estimated AI for SVR"], loc="upper center", fontsize=20,bbox_to_anchor=(0.5, 1.07))
plt.show()
